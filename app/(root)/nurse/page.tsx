      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <motion.div variants={itemVariants} className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            <h2 className="text-xl font-semibold text-red-700 mb-2">Patient Care</h2>
            <p className="text-red-600">Provide exceptional care to your patients</p>
          </motion.div>
          <motion.div variants={itemVariants} className="bg-white p-6 rounded-lg shadow-lg text-center">
            <Clock className="w-12 h-12 text-red-500 mx-auto mb-4" />
            <h2 className="text-xl font-semibold text-red-700 mb-2">Shift Management</h2>
            <p className="text-red-600">Manage your shifts efficiently</p>
          </motion.div>
          <motion.div variants={itemVariants} className="bg-white p-6 rounded-lg shadow-lg text-center">
            <Calendar className="w-12 h-12 text-red-500 mx-auto mb-4" />
            <h2 className="text-xl font-semibold text-red-700 mb-2">Schedule</h2>
            <p className="text-red-600">View and manage your work schedule</p>
          </motion.div>
        </motion.div>
