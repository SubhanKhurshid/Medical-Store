...
const FrontDeskPage = () => {
    ...
    >
        ...
        <div className="container px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <motion.div className="space-y-2" variants={itemVariants}>
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl bg-clip-text text-transparent bg-gradient-to-r from-red-800 to-red-500">
      ...
      <section className="w-full py-12 md:py-20 lg:py-28">
        <div className="container px-4 sm:px-6 lg:px-8">
          <motion.h2
            className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-12 bg-clip-text text-transparent  bg-gradient-to-r from-red-700 to-red-500"
            variants={itemVariants}
          >
  ...
  <Link href={item.href} passHref>
    <Button
      className="h-40 sm:h-48 md:h-56 text-xl sm:text-2xl md:text-3xl font-semibold bg-white hover:bg-red-50 text-red-700 border-2 border-red-200 transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl w-full rounded-2xl flex flex-col items-center justify-center space-y-4 overflow-hidden group relative"
    >
      <div className="absolute inset-0 bg-gradient-to-br from-red-400 to-red-500 opacity-0 group-hover:opacity-10 transition-opacity duration-300 ease-in-out"></div>
...
>
  <div className="container px-4 sm:px-6 lg:px-8">
    <motion.h2
      className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-12 text-red-700"
      variants={itemVariants}
    >
      Quick Stats
    </motion.h2>
    ...
    >
      {[
        ...
        <motion.div
          key={index}
          className="bg-white p-6 rounded-xl shadow-lg border border-red-100 flex flex-col items-center justify-center space-y-2 transition-all duration-300 ease-in-out hover:shadow-xl hover:border-red-300"
          variants={itemVariants}
        >
          <span className="text-4xl font-bold text-red-600">{stat.value}</span>
